    ...
    <div className="dark:bg-white bg-black  dark:bg-dot-black/[0.2] bg-dot-white/[0.2] px-[2rem] md:px-[8rem]">
      ...
      <div className="flex flex-col justify-center px-4  md:px-[4rem]">
        ...
        <h2 className="font-Poppins text-xl md:text-[35px] pt-[2rem] text-white font-bold">
          All Neptune  Plumbers are Qualified and the best at what <br /><br /> they do.
        </h2>

        <p className="font-Poppins text-xl md:text-xl pt-[2rem] text-slate-400 ">
          Neptune Plumbers offers an extensive array of Plumbing Services in Elite. If you&apos;re in search of the most affordable plumber in Elite, your search ends here.
          <br />
          <br />
          Neptune  Plumbers operates around the clock to ensure all your plumbing requirements are met. We provide a wide range of plumbing services.
