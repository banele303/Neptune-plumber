    ...
    return (
        <div className="dark:bg-white bg-black  dark:bg-dot-black/[0.2] bg-dot-white/[0.2] px-[2rem] md:px-[4rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-9">
                <motion.div
                    className="container mx-auto  h-[50vh] w-full md:w-1/2 mt-8 md:mt-[6rem] rounded-md"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1 }}
                >
                    <Image
                        src="/img/neptune-sink.jpeg" // the image file should be in the public folder
...
So why wait? Give me a call today and let me take the stress out of your geyser troubles. With my help, you can rest easy knowing your geyser is in good hands.🛠️💧
 ...
 <motion.div
                ...
                >
                    <Image
                        src="/img/neptune-geyse1.jpeg" // the image file should be in the public folder
                        alt="southflow marketing agency no contract no set up fee"
                        width={300} // the original image width
                        height={400} // the original image height
                        layout="responsive" // this will make the image responsive
 ...
 <div className="mt-[4rem]">
  ...
  <motion.div
                    className="container mx-auto  md:h-1/2 w-full md:w-2/4 mt-3 md:mt-[6rem] rounded-md"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1 }}
                >
                    <Image
                        src="/img/neptune.jpeg" // the image file should be in the public folder
                        alt="southflow marketing agency no contract no set up fee"
                        width={300} // the original image width
                        height={400} // the original image height
                        layout="responsive" // this will make the image responsive
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-9 mt-[7rem]">
                ...
                <motion.div
                    className="container mx-auto  h-[20vh] w-full md:w-3/4 mt-8 md:mt-[6rem] rounded-md"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 1 }}
                >
